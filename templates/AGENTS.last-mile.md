<!--
このファイルは Last-Mile Shared Context Protocol の AGENTS.md 挿入用テンプレ。
...
同期方針:
  agents-md-template リポジトリにも同内容を `templates/last-mile-rule.md` として配置し、
  2 リポジトリで同期する (WBS §14.2 P9-08 注記、2026-05-17 追記)。
-->
...
- `docs/SECURITY.md` (Phase 8 PR #7 で追加) — Redaction / 機密マスク
